...
DEGREES = [0, 3, 6, 10, 13, 16, 20, 23, 26, 30, 33, 36, 40, 43, 46, 50, 53, 56, 60, 63, 66, 70, 73, 76, 80, 83, 86, 90, 93, 96, 100,
...
UVOLTS = [0, 119, 238, 397, 517, 637, 798, 919, 1041, 1203, 1326, 1448, 1612, 1735, 1858, 2023, 2147, 2271, 2436, 2561, 2685, 2851, 2976, 3100, 3267,
...
class ADS1118(SensorBase):
    ...
    def C_to_uV(self, C):
        if not 0 <= C <= 1200:
            self.fault("C out of range. Expected value between 0 and 1200, got {}".format(C))
